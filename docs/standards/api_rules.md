...
Intended contracts for WikiAI APIs. If the running MVP differs, [current MVP](../reference/current-mvp.md) and the [API reference](../reference/api.md) win for shipped behavior.
