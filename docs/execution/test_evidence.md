...
> **Note:** Execution notes are session working memory, not a product contract. This file records validation that was run, not a guarantee that the same commands still pass.
