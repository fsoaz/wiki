...
> **Note:** This page is product intent. Shipped behavior is documented in [current MVP](../reference/current-mvp.md). Terms such as [claim](../glossary.md#claim) and [epistemic database](../glossary.md#epistemic-database) are defined in the glossary.
